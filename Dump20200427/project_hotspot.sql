...
CREATE TABLE `hotspot` (
  ...
  `status` varchar(45) DEFAULT 'MIGHT BE',
  PRIMARY KEY (`meter_no`),
  KEY `meter_no_idx` (`meter_no`)
...
INSERT INTO `hotspot` VALUES (123,'MIGHT BE'),(124,'MIGHT BE'),(125,'MIGHT BE'),(126,'MIGHT BE');
...
-- Dump completed on 2020-04-27 14:52:50
